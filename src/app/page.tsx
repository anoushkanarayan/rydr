...
export default function Home() {
  ...
  return (
    <div className="relative">
      ...
      <section ref={howItWorksRef} className="bg-white min-h-[60vh] w-full pt-0 pb-10 sm:pb-20 px-4 sm:px-0">
        <div className="w-full sm:w-[95%] sm:max-w-4xl mx-auto flex flex-col items-center pt-8 sm:pt-12">
